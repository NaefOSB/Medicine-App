...
class RoundedTextFieldArea extends StatefulWidget {
  ...
  @override
  _RoundedTextFieldAreaState createState() => _RoundedTextFieldAreaState();
}

class _RoundedTextFieldAreaState extends State<RoundedTextFieldArea> {
  bool obscureText;
